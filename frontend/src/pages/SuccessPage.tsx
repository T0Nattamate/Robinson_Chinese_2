  ...
  return (
    <div className="font-kanit bg-[var(--bg)] w-full min-h-screen flex flex-col items-center relative">
      ...
      <div className="flex flex-col justify-center items-center w-full px-5 text-center gap-8 ">
        ...
        {/* Success Message */}
        <h1 className="text-2xl md:text-2xl text-black leading-relaxed pt-16">
        ...
        <div className="w-50 md:w-50 relative">
          <img src="Thank you 761x650 px .png" alt="success-icon" className="w-full h-auto" />
        </div>

        {/* Continue Button */}
        <Link
          to="/menu"
          className="w-full px-6 py-3 bg-[var(--button)] text-white rounded-lg shadow-md transform transition hover:scale-105"
        >
          ดำเนินการต่อ
        </Link>
      </div>
